...
public class DBService {
	...
	public void instantiateTestDatabase () throws ParseException {
		...
		this.categorias.save(Arrays.asList(cat1, cat2, cat3, cat4, cat5, cat6, cat7));
		this.produtos.save(Arrays.asList(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11));
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "kaiquerijkaardteste@gmail.com", "3333333", TipoCliente.PESSOAFISICA);
